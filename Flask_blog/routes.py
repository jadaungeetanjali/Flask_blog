...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='jadaungeetanjali@gmail.com', recipients=[user.email])
    msg.body = "To reset your password visit the following link: {}. If you didn't make this request then simply ignore this email and no changes will be made".format({url_for('reset_token', token=token, _external=True)})
    mail.send(msg)
